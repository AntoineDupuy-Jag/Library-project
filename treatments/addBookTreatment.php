<?php
    ...
    // Send object newBook to mongo ->
    try {
        $newBook = new BookManager($title, $author, $releaseYear, $category, $collection, $upload_file);
        $newBook->sendToMongo($newBook);
        $validateMsg = "Le livre a été ajouté avec succès";
